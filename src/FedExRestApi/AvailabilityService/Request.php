...
namespace FedExRestApi\AvailabilityService;


use FedExRestApi\AbstractRequest;
use FedExRestApi\AvailabilityService\ComplexType\PackageAndServiceOptionsRequest;
use FedExRestApi\AvailabilityService\ComplexType\SpecialServiceOptionsRequest;
