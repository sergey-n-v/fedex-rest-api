 ...
 * @property AvBaseProcessOutputVO $output

 */
class AvAvailabilitycxsResponseVO extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'AvAvailabilitycxsResponseVO';
     ...
     *
     * Example:
     * @param AvBaseProcessOutputVO $output
     * @return $this
     */
    public function setOutput(AvBaseProcessOutputVO $output)
    {
