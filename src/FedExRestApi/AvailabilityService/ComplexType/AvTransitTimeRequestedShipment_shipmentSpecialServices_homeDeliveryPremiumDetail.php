 ...
 */
class AvTransitTimeRequestedShipment_shipmentSpecialServices_homeDeliveryPremiumDetail extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'AvTransitTimeRequestedShipment_shipmentSpecialServices_homeDeliveryPremiumDetail';
