 ...
 * @property TrackBaseProcessOutputVO_TCN $output

 */
class TrackTrkcResponseVO_TCN extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'TrackTrkcResponseVO_TCN';
     ...
     *
     * Example:
     * @param TrackBaseProcessOutputVO_TCN $output
     * @return $this
     */
    public function setOutput(TrackBaseProcessOutputVO_TCN $output)
    {
     ...
     * Get output
     *
     * @return TrackBaseProcessOutputVO_TCN
     */
