 ...
 */
class OpenShipUsmcaCommercialInvoiceCertificationOfOriginDetail extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'OpenShipUsmcaCommercialInvoiceCertificationOfOriginDetail';
