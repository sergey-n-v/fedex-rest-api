 ...
 * @property OpenShipBaseProcessOutputVO_AddPackagesToOpenShipment $output

 */
class OpenShipSHPCResponseVO_AddPackagesToOpenShipment extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'OpenShipSHPCResponseVO_AddPackagesToOpenShipment';
     ...
     *
     * Example:
     * @param OpenShipBaseProcessOutputVO_AddPackagesToOpenShipment $output
     * @return $this
     */
    public function setOutput(OpenShipBaseProcessOutputVO_AddPackagesToOpenShipment $output)
    {
     ...
     * Get output
     *
     * @return OpenShipBaseProcessOutputVO_AddPackagesToOpenShipment
     */
