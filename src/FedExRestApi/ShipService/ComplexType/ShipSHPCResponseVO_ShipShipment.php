 ...
 * @property ShipBaseProcessOutputVO_ShipShipment $output

 */
class ShipSHPCResponseVO_ShipShipment extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'ShipSHPCResponseVO_ShipShipment';
     ...
     *
     * Example:
     * @param ShipBaseProcessOutputVO_ShipShipment $output
     * @return $this
     */
    public function setOutput(ShipBaseProcessOutputVO_ShipShipment $output)
    {
     ...
     * Get output
     *
     * @return ShipBaseProcessOutputVO_ShipShipment
     */
