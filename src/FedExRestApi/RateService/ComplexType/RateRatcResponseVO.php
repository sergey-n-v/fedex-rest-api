 ...
 * @property RateBaseProcessOutputVO $output

 */
class RateRatcResponseVO extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'RateRatcResponseVO';
     ...
     *
     * Example:
     * @param RateBaseProcessOutputVO $output
     * @return $this
     */
    public function setOutput(RateBaseProcessOutputVO $output)
    {
     ...
     * Get output
     *
     * @return RateBaseProcessOutputVO
     */
