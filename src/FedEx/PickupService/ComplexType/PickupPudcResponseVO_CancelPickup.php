 ...
 * @property PickupBaseProcessOutputVO_CancelPickup $output

 */
class PickupPudcResponseVO_CancelPickup extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'PickupPudcResponseVO_CancelPickup';
     ...
     * 
     * Example: 
     * @param PickupBaseProcessOutputVO_CancelPickup $output
     * @return $this
     */
    public function setOutput(PickupBaseProcessOutputVO_CancelPickup $output)
    {
     ...
     * Get output
     *
     * @return PickupBaseProcessOutputVO_CancelPickup
     */
