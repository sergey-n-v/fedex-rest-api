 ...
 * @property PickupBaseProcessOutputVO_PickupAvailability $output

 */
class PickupPudcResponseVO_PickupAvailability extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'PickupPudcResponseVO_PickupAvailability';
     ...
     * 
     * Example: 
     * @param PickupBaseProcessOutputVO_PickupAvailability $output
     * @return $this
     */
    public function setOutput(PickupBaseProcessOutputVO_PickupAvailability $output)
    {
     ...
     * Get output
     *
     * @return PickupBaseProcessOutputVO_PickupAvailability
     */
