 ...
 * @property OpenShipCXSError500[] $errors

 */
class OpenShipErrorResponseVO500_2 extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'OpenShipErrorResponseVO500_2';
     ...
     * 
     * Example: 
     * @param OpenShipCXSError500[] $errors
     * @return $this
     */
