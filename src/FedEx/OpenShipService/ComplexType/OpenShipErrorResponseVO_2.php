 ...
 * @property OpenShipCXSError_2[] $errors

 */
class OpenShipErrorResponseVO_2 extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'OpenShipErrorResponseVO_2';
     ...
     * 
     * Example: 
     * @param OpenShipCXSError_2[] $errors
     * @return $this
     */
