 ...
 * @property OpenShipBaseProcessOutputVO_GetOpenShipmentResults $output

 */
class OpenShipSHPCResponseVO_GetOpenShipmentResults extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'OpenShipSHPCResponseVO_GetOpenShipmentResults';
     ...
     * 
     * Example: 
     * @param OpenShipBaseProcessOutputVO_GetOpenShipmentResults $output
     * @return $this
     */
    public function setOutput(OpenShipBaseProcessOutputVO_GetOpenShipmentResults $output)
    {
     ...
     * Get output
     *
     * @return OpenShipBaseProcessOutputVO_GetOpenShipmentResults
     */
