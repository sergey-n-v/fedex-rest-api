 ...
 * @property OpenShipCXSError[] $errors

 */
class OpenShipErrorResponseVO extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'OpenShipErrorResponseVO';
