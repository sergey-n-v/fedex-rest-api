 ...
 * @property OpenShipBaseProcessOutputVO_ConfirmOpenShipment $output

 */
class OpenShipSHPCResponseVO_ConfirmOpenShipment extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'OpenShipSHPCResponseVO_ConfirmOpenShipment';
     ...
     * 
     * Example: 
     * @param OpenShipBaseProcessOutputVO_ConfirmOpenShipment $output
     * @return $this
     */
    public function setOutput(OpenShipBaseProcessOutputVO_ConfirmOpenShipment $output)
    {
     ...
     * Get output
     *
     * @return OpenShipBaseProcessOutputVO_ConfirmOpenShipment
     */
