 ...
 * @property OpenShipReturnShipmentDetail $returnShipmentDetail
 ...
 * @property OpenShipPendingShipmentDetail $pendingShipmentDetail
 ...
 */
class OpenShipShipmentSpecialServicesRequested extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'OpenShipShipmentSpecialServicesRequested';
     ...
     * 
     * Example: 
     * @param OpenShipReturnShipmentDetail $returnShipmentDetail
     * @return $this
     */
    public function setReturnShipmentDetail(OpenShipReturnShipmentDetail $returnShipmentDetail)
    {
     ...
     *
     * @return OpenShipReturnShipmentDetail
     */
     ...
     * 
     * Example: 
     * @param OpenShipPendingShipmentDetail $pendingShipmentDetail
     * @return $this
     */
    public function setPendingShipmentDetail(OpenShipPendingShipmentDetail $pendingShipmentDetail)
    {
     ...
     *
     * @return OpenShipPendingShipmentDetail
     */
