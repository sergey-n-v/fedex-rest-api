...
/**
 * Wrapper class for RetrievePackageInOpenshipmentOutputVO. It holds transactionId and output.
 *
 * @author      Asabix
 ...
 * @property OpenShipBaseProcessOutputVO_RetrievePackageInOpenShipment $output

 */
class OpenShipSHPCResponseVO_RetrievePackageInOpenShipment extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'OpenShipSHPCResponseVO_RetrievePackageInOpenShipment';
     ...
     * 
     * Example: 
     * @param OpenShipBaseProcessOutputVO_RetrievePackageInOpenShipment $output
     * @return $this
     */
    public function setOutput(OpenShipBaseProcessOutputVO_RetrievePackageInOpenShipment $output)
    {
     ...
     * Get output
     *
     * @return OpenShipBaseProcessOutputVO_RetrievePackageInOpenShipment
     */
