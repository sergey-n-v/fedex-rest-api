 ...
 *
 */
class OpenShipTypes extends AbstractSimpleType
{
  ...
  const _USMCA_CERTIFICATION_OF_ORIGIN_CANADA_ENGLISH = 'USMCA_CERTIFICATION_OF_ORIGIN_CANADA_ENGLISH';
  const _USMCA_CERTIFICATION_OF_ORIGIN_CANADA_FRENCH = 'USMCA_CERTIFICATION_OF_ORIGIN_CANADA_FRENCH';
  const _USMCA_CERTIFICATION_OF_ORIGIN_SPANISH = 'USMCA_CERTIFICATION_OF_ORIGIN_SPANISH';
  const _USMCA_CERTIFICATION_OF_ORIGIN_UNITED_STATES = 'USMCA_CERTIFICATION_OF_ORIGIN_UNITED_STATES';
