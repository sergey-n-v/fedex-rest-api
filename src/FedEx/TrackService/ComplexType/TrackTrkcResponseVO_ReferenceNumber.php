 ...
 * @property TrackBaseProcessOutputVO_ReferenceNumber $output

 */
class TrackTrkcResponseVO_ReferenceNumber extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'TrackTrkcResponseVO_ReferenceNumber';
     ...
     * 
     * Example: 
     * @param TrackBaseProcessOutputVO_ReferenceNumber $output
     * @return $this
     */
    public function setOutput(TrackBaseProcessOutputVO_ReferenceNumber $output)
    {
     ...
     * Get output
     *
     * @return TrackBaseProcessOutputVO_ReferenceNumber
     */
