 ...
 * @property TrackBaseProcessOutputVO_Associated $output

 */
class TrackTrkcResponseVO_Associated extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'TrackTrkcResponseVO_Associated';
     ...
     * 
     * Example: 
     * @param TrackBaseProcessOutputVO_Associated $output
     * @return $this
     */
    public function setOutput(TrackBaseProcessOutputVO_Associated $output)
    {
     ...
     * Get output
     *
     * @return TrackBaseProcessOutputVO_Associated
     */
