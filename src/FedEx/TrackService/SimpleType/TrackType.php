 ...
 *
 */
class TrackType extends AbstractSimpleType
{
  ...
  const _FEDEX_OFFICE_JOB_ORDER_NUMBER = 'FEDEX_OFFICE_JOB_ORDER_NUMBER';
  ...
  const _TRACKING_CONTROL_NUMBER = 'TRACKING_CONTROL_NUMBER';
  ...
  const _VIRTUAL_CONSOLIDATION = 'VIRTUAL_CONSOLIDATION';
}
