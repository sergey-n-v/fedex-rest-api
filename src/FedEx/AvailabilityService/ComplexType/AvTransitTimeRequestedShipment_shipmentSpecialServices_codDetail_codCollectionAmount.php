 ...
 */
class AvTransitTimeRequestedShipment_shipmentSpecialServices_codDetail_codCollectionAmount extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'AvTransitTimeRequestedShipment_shipmentSpecialServices_codDetail_codCollectionAmount';
