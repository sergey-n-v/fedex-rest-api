 ...
 * @property AvCXSError500[] $errors

 */
class AvErrorResponseVO500 extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'AvErrorResponseVO500';
