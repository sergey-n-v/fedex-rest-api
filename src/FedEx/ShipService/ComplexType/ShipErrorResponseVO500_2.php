 ...
 * @property ShipCXSError500[] $errors

 */
class ShipErrorResponseVO500_2 extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'ShipErrorResponseVO500_2';
