 ...
 * @property ShipCXSError_2[] $errors

 */
class ShipErrorResponseVO_2 extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'ShipErrorResponseVO_2';
