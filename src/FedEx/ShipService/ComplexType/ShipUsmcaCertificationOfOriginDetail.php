 ...
 * @property ShipRetrieveDateRange $blanketPeriod
 * @property string $certifierJobTitle

 */
class ShipUsmcaCertificationOfOriginDetail extends AbstractComplexType
{
    /**
     ...
     * @var string
     */
    protected $name = 'ShipUsmcaCertificationOfOriginDetail';
     ...
     * 
     * Example: 
     * @param ShipRetrieveDateRange $blanketPeriod
     * @return $this
     */
    public function setBlanketPeriod(ShipRetrieveDateRange $blanketPeriod)
    {
